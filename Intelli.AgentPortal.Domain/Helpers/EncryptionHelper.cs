...
namespace Intelli.AgentPortal.Domain
{
    public class EncryptionHelper
    {
        ...
        public static int DecryptUsersPerCompany(string entityUsersPerCompany)
        {
            int usersPerCompany;
            bool alreadyParsed = Int32.TryParse(entityUsersPerCompany, out usersPerCompany);
            if (!alreadyParsed)
            {
                bool isParsable = Int32.TryParse(DecryptString(entityUsersPerCompany), out usersPerCompany);
                if (isParsable)
