...
{
    public class EUROBANKActions : ICompanyActions
    {
        public List<CustomerData> AgentCustomerData(Batch batch)
        {
            ...
            if (batch.BatchSourceId == batchSourcesList.FirstOrDefault(d => d.EnumValue == BatchSourcesKeys.Eurobank)?.Id ||
            batch.BatchSourceId == batchSourcesList.FirstOrDefault(d => d.EnumValue == BatchSourcesKeys.EurobankEKyc)?.Id ||
            batch.BatchSourceId == batchSourcesList.FirstOrDefault(d => d.EnumValue == BatchSourcesKeys.EurobankForeigners)?.Id)
            {
