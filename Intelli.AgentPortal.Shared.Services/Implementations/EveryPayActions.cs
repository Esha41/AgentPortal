...
{
    public class EveryPayActions : ICompanyActions
    {
        public List<CustomerData> AgentCustomerData(Batch batch)
        {
            ...
            if (batch.BatchSourceId == batchSourcesList.FirstOrDefault(d => d.EnumValue == BatchSourcesKeys.EveryPayGrID)?.Id ||
            batch.BatchSourceId == batchSourcesList.FirstOrDefault(d => d.EnumValue == BatchSourcesKeys.EveryPayNotGrID)?.Id)
            {
            ...
            else if (batch.BatchSourceId == batchSourcesList.FirstOrDefault(d => d.EnumValue == BatchSourcesKeys.EveryPayeKYC)?.Id)
            {
