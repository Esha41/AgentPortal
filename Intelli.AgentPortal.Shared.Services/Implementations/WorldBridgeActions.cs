...
{
    public class WorldBridgeActions : ICompanyActions
    {
        public List<CustomerData> AgentCustomerData(Batch batch)
        {
            ...
            if (batch.BatchSourceId == batchSourcesList.FirstOrDefault(d => d.EnumValue == BatchSourcesKeys.WorldBridgeNoVideo)?.Id)
            {
            ...
            else if (batch.BatchSourceId == batchSourcesList.FirstOrDefault(d => d.EnumValue == BatchSourcesKeys.WorldBridgeekyc)?.Id)
            {
